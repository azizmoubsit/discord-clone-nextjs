...
export const ChatItem = ({
  ...
  const handleSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      await axios.patch(url, { content: values.content });
      form.reset();
    } catch (error) {
      console.error(error);
    } finally {
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
                      ...
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            ...
                            className="p-2 bg-zinc-200/900 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
                            {...field}
                          />
                        </div>
                      </FormControl>
              ...
              <span className="text-[10px] mt-1 text-zinc-400">
                Press escape to canel, enter to save
              </span>
            </Form>
          )}
        </div>
